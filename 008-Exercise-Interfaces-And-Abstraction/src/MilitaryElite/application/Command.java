...
import src.MilitaryElite.common.MissionImpl;
import src.MilitaryElite.common.RepairImpl;
...
import src.MilitaryElite.interfaces.Soldier;
import src.MilitaryElite.models.*;
...
public class Command {
    ...
    public void execute(String command, List<String> tokens) {
        ...
        switch (command) {
            case "Private" -> soldier = new PrivateImpl(id,
                                                        firstName,
                                                        lastName,
            ...
            case "Spy" -> soldier = new SpyImpl(id, firstName, lastName, tokens.get(3));
        }
